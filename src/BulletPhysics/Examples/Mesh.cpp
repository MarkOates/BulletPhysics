...
void Mesh::set_shape_model(AllegroFlare::Model3D* shape_model)
{
...
void Mesh::initialize()
{
   if (!((!initialized)))
   {
      ...
      error_message << "[BulletPhysics::Examples::Mesh::initialize]: error: guard \"(!initialized)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::initialize]: error: guard \"(!initialized)\" not met");
   }
   if (!((!destroyed)))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::initialize]: error: guard \"(!destroyed)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::initialize]: error: guard \"(!destroyed)\" not met");
   }
...
btConvexHullShape* Mesh::create_convex_shape(AllegroFlare::Model3D* model)
{
   if (!(model))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::create_convex_shape]: error: guard \"model\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::create_convex_shape]: error: guard \"model\" not met");
   }
...
std::pair<btRigidBody*, btCollisionShape*> Mesh::create_dynamic_mesh_shape(AllegroFlare::Model3D* model, float x, float y, float z)
{
   if (!(model))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::create_dynamic_mesh_shape]: error: guard \"model\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::create_dynamic_mesh_shape]: error: guard \"model\" not met");
   }
...
void Mesh::step_physics(double time_step)
{
   // Simulate physics
   //for (int i = 0; i < 150; i++)
   //{
...
void Mesh::output_body_positions_and_rotations(double time_step)
{
...
void Mesh::capture_sphere_body_position_and_rotation(AllegroFlare::Vec3D* position, AllegroFlare::Vec3D* rotation_euler)
{
   if (!(position))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_sphere_body_position_and_rotation]: error: guard \"position\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_sphere_body_position_and_rotation]: error: guard \"position\" not met");
   }
...
void Mesh::build_transform_bullet(ALLEGRO_TRANSFORM* transform, AllegroFlare::Placement3D* placement_3d)
{
   if (!(transform))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::build_transform_bullet]: error: guard \"transform\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::build_transform_bullet]: error: guard \"transform\" not met");
   }
   if (!(placement_3d))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::build_transform_bullet]: error: guard \"placement_3d\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::build_transform_bullet]: error: guard \"placement_3d\" not met");
   }
...
void Mesh::capture_cube_body_position_and_rotation(AllegroFlare::Vec3D* position, AllegroFlare::Vec3D* rotation_euler, int cube_index)
{
   if (!(position))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_cube_body_position_and_rotation]: error: guard \"position\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_cube_body_position_and_rotation]: error: guard \"position\" not met");
   }
   if (!(rotation_euler))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_cube_body_position_and_rotation]: error: guard \"rotation_euler\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_cube_body_position_and_rotation]: error: guard \"rotation_euler\" not met");
   }
...
void Mesh::capture_shape_body_position_and_rotation(AllegroFlare::Vec3D* position, AllegroFlare::Vec3D* rotation_euler, int shape_index)
{
   if (!(position))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"position\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"position\" not met");
   }
   if (!(rotation_euler))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"rotation_euler\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"rotation_euler\" not met");
   }
   if (!((shape_index >= 0)))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"(shape_index >= 0)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"(shape_index >= 0)\" not met");
   }
   if (!((shape_index < shapes.size())))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"(shape_index < shapes.size())\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_shape_body_position_and_rotation]: error: guard \"(shape_index < shapes.size())\" not met");
   }
...
void Mesh::capture_rigid_body_position_and_rotation(AllegroFlare::Vec3D* position, AllegroFlare::Vec3D* rotation_euler, btRigidBody* rigid_body)
{
   if (!(position))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_rigid_body_position_and_rotation]: error: guard \"position\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_rigid_body_position_and_rotation]: error: guard \"position\" not met");
   }
   if (!(rotation_euler))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_rigid_body_position_and_rotation]: error: guard \"rotation_euler\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_rigid_body_position_and_rotation]: error: guard \"rotation_euler\" not met");
   }
   if (!(rigid_body))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::capture_rigid_body_position_and_rotation]: error: guard \"rigid_body\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::capture_rigid_body_position_and_rotation]: error: guard \"rigid_body\" not met");
   }
   btTransform bullet_transform;
...
void Mesh::destroy()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::destroy]: error: guard \"(!destroyed)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::destroy]: error: guard \"(!destroyed)\" not met");
   }
   if (!(initialized))
   {
      std::stringstream error_message;
      error_message << "[BulletPhysics::Examples::Mesh::destroy]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[BulletPhysics::Examples::Mesh::destroy]: error: guard \"initialized\" not met");
   }
   // Cleanup
